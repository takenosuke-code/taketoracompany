...
export default async function RootLayout({
  ...
  // Get the first category from Supabase for navigation
  const supabase = createClient();
  const { data: products } = await supabase.from('products').select('category').limit(1);
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div>
                ...
                <p className="text-sm font-light leading-relaxed text-stone-400">
                  A curated sanctuary of premium collectibles and artisan treasures in Tokyo.
                </p>
              </div>
              
              {/* Visit */}
              <div>
                <h4 className="font-medium text-stone-200 mb-4 tracking-wide">Visit Our Boutique</h4>
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  <a href="#" className="text-stone-400 hover:text-amber-300 transition-colors duration-300">
