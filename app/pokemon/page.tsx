...
export const metadata: Metadata = {
  title: 'Pokémon Cards | Taketora - Premium Japanese Collectibles',
  description: 'Browse our collection of authentic Pokémon cards imported directly from Japan. Premium quality collectibles with original packaging.',
};

export default async function PokemonPage() {
  const supabase = createClient();
  
  // Fetch all pokemon card products from Supabase
  ...
  // Debug logging
  console.log('🔍 [POKEMON PAGE] Fetch result:');
  ...
  if (products && products.length > 0) {
    console.log('  - First product:', {
      ...
      has_image: !!(products[0].image_url || products[0].image)
    });
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
        {/* No breadcrumbs for pokemon page - clean layout */}
        ...
        {products && products.length > 0 ? (
          ...
          <div className="text-center py-12 sm:py-16">
            <p className="text-[#F2E8DC]/60 text-lg sm:text-xl font-light">
              No Pokémon cards available at this time.
            </p>
          </div>
        )}
      </div>
